...
def process_weapon_detections(results_hammer, results_knife, results_gun, results_bat, confidence_threshold):
    weapon_boxes = []
    weapon_classes = []
    weapon_confidences = []
...
try:
    while True:
        ...
        boxes_weapon, classes_weapon, confidences_weapon = process_weapon_detections(
            results_hammer, results_knife, results_gun, results_bat, confidence_threshold
        )
